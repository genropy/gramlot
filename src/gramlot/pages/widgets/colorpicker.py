...
"""Interactive review cases for colorpicker."""
from ...widget_test_page import WidgetTestPage


class ColorpickerTestPage(WidgetTestPage):
    widget_tag = "colorpicker"
    collection = "colorpicker"

    def test_01_basic(self, pane):
        """Try the component with the mouse and keyboard and observe its behavior."""
        pane.data(".value", "#336699")
        pane.colorpicker(value="^.value", lbl="Test value")
