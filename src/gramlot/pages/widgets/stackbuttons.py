...
class StackButtonsTestPage(WidgetTestPage):
    widget_tag = "stackButtons"
    collection = "layout"
    ...
    def test_01_basic(self, pane):
        ...
        pane.stackButtons(stackNodeId="stackButtons_named")
        stack = pane.stackContainer(selectedPage="^.page", nodeId="stackButtons_named", height="150px")
    ...
    def test_02_isolation(self, pane):
        ...
        pane.stackButtons(stackNodeId="stackButtons_indexed")
        stack = pane.stackContainer(selected="^.index", nodeId="stackButtons_indexed", height="150px")
