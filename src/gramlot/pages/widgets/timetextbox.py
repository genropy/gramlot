...
"""Interactive review cases for timeTextBox."""
from ...widget_test_page import WidgetTestPage


class TimeTextBoxTestPage(WidgetTestPage):
    widget_tag = "timeTextBox"
    collection = "inputs"

    def test_01_basic(self, pane):
        """Try the component with the mouse and keyboard and observe its behavior."""
        pane.data(".value", "09:30")
        pane.timeTextBox(value="^.value", lbl="Test value")
